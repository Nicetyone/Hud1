...
RegisterNetEvent('nty_mumble:update_status')
AddEventHandler('nty_mumble:update_status', function(poziom)
	local mypoziom = poziom

	if lastPoziom == nil or lastPoziom ~= mypoziom then
		SendNUIMessage(
			{
				micrange = mypoziom
			}
